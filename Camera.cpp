...
Camera::Camera(glm::mat4 projection_matrix)
	: _viewMatrix(glm::mat4(1)), _projMatrix(projection_matrix), _mouseX(0), _mouseY(0), ooo(0.0f), ggg(0.0f), _strafe(glm::vec3(0)) 
{ }

Camera::Camera(int window_width, int window_height)
	: Camera(vklCreatePerspectiveProjectionMatrix(glm::radians(60.0f), static_cast<float>(window_width) / static_cast<float>(window_height), 0.1f, 1000.0f))
{ }
